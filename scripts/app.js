...
APP.Main = (function() {
  ...
  function showStory(id) {
    ...
    story.classList.add('story-details_in');
  }
  ...
  function hideStory(id) {
    ...
    story.classList.remove('story-details_in');
  }

  main.addEventListener('scroll', function() {
    /** These three variables are declared in advance to
      * minimize running of layout triggering operations
      */
